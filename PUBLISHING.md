...
GitHub Pages needs one initial repository setup: create the public repository, connect this checkout as `origin`, and select **GitHub Actions** under Settings → Pages → Build and deployment. After that, every push to `main` updates the same public demo without a manual file-copy step.
