...
def discover() -> tuple[int, list[dict[str, Any]]]:
    options = {
    ...
    for entry in entries:
        ...
        if not video_id or not TITLE_PATTERN.search(title):
            continue
        candidates.append(
            {
                "id": video_id,
...
def main() -> int:
    ...
    channel_count, candidates = discover()
