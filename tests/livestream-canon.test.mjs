...
test("each source has an honest evidence tier and playable source link", () => {
  ...
  assert.equal(showReads.some((read) => /for the room breaks|for a room breaks|\.\s+the chat (?:leaves|stays)/.test(read)), false, "show reads do not retain the broken route/chat sentence joins");
