(function (root) {
  ...
  var highlights = [
    ...
    H(5760, 5940, "FAN SIGNAL", "LOOMIS AND CHALLIS GET A PUBERTY REQUEST", "A fan asks for a birthday shoutout for Jared. The character lane goes wildly off the rails, but the archive keeps it as a fan-request performance rather than pretending it was part of the film review.", ["Dr. Loomis", "Dr. Challis"]),
