(function (root) {
  ...
  sources["34BwSiucNEI"] = Object.freeze({
    ...
    story: Object.freeze([
      ...
      { at: 3201, end: 4800, label: "MOVIE NEWS, PRACTICAL TURTLES, AND THE ART THE CLOWN GAME", body: "The hosts jump from a Friendsgiving invitation to practical-versus-CG Teenage Mutant Ninja Turtles, the Death of Superman comic, and an Art the Clown side-scroller they intend to buy and play together." },
    ...
    fanRead: Object.freeze({
      loved: Object.freeze({ at: 2231, end: 2281, label: "DAY-ONE PINHEAD", topic: "the cleanest shared enthusiasm", body: "Play from 37:11. The Hellraiser game trailer earns the rare WWAM verdict of day-one purchase, with Doug Bradley's return sealing it.", playAt: 2231, playEnd: 2281 }),
