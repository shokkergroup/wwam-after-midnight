  ...
  function showWikiFor(source, receipts, characterNames, comedyCategories) {
    ...
    var laneById = {
      ...
      "up-in-ya": lane(
        "up-in-ya",
        "WWAM UP IN YA",
        "Only moment receipts explicitly labeled UP IN YA in this source's registered distill.",
        "No moment explicitly labeled UP IN YA is registered for this show yet.",
        upInYa,
        [
