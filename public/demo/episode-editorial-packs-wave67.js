(function (root) {
  ...
  sources["qfJFZaC9pTE"] = Object.freeze({
    ...
    editorialPass: "2026-08-10 third fine-toothed full-audio read of the November 3, 2025 Welcome to Derry episode-two recap; official caption ledger, local audio windows, and aligned Whisper candidates rechecked across the morning close-up, Conjuring bet, hayride comparison, sports-betting detour, tip-jar/FAM lane, Derry airbase weapon, pickle-juice scenes, Halloween etiquette, Loomis stage directions, and the streaming-price sign-off; 19 additional source-bound jump points added",
    ...
    highlights: Object.freeze([
      ...
      { at: 15, end: 35, category: "THE ROOM BREAKS", label: "LEGS UP IN THE AIR", excerpt: "The welcome keeps escalating into a legs-up-in-the-air visual gag before anybody has even reached the recap." },
      { at: 52, end: 82, category: "STRAIGHT TO STEVE'S ASSHOLE", label: "CAMBODIA CONJURING REFUND", excerpt: "The Conjuring bet is described as an international robbery, with the bad-movie refund already emotionally spent." },
      { at: 181, end: 201, category: "WWAM UP IN YA", label: "AXE-TO-THE-HEAD SYMPATHY", excerpt: "The hayride-looking villain gets mocked and defended at the same time because his cheating-wife revenge is apparently relatable." },
      { at: 261, end: 281, category: "FAN SIGNAL", label: "THE GUY WHO THROWS TOUCHDOWNS", excerpt: "A sports question receives the only answer the room needs: the quarterback is the guy who throws touchdowns." },
      { at: 364, end: 384, category: "THE ROOM BREAKS", label: "VICTORIA'S SECRET FOOTBALL", excerpt: "Lady football turns into a live attempt to identify whether the fan meant lingerie football or an actual league." },
      { at: 418, end: 438, category: "FAN SIGNAL", label: "THE JAW-HANGING TIP JAR", excerpt: "The Stream Elements explanation nearly gets swallowed by a complaint about somebody talking with his jaw hanging open." },
      { at: 870, end: 890, category: "THE ROOM BREAKS", label: "THE GUNN-WHEDON NAME BLENDER", excerpt: "James Gunn and Joss Whedon get thrown into the same mental blender until the host realizes which director the conversation actually meant." },
      { at: 960, end: 980, category: "FAN SIGNAL", label: "CHUNKY JORDY'S DAWN RECEIPT", excerpt: "A fan's new Dawn of the Dead video becomes the excuse to defend the remake while still giving the original its crown." },
      { at: 1250, end: 1270, category: "STRAIGHT TO STEVE'S ASSHOLE", label: "CHAPS MY BUNGHOLE", excerpt: "The betting loss gets translated into delivery-route misery, with the fragile label treated like a personal attack." },
      { at: 1432, end: 1452, category: "WWAM UP IN YA", label: "SPICY COFFEE, LITTLE CAESARS", excerpt: "A dream-reveal celebration gives way to spicy coffee and a Little Caesars run, an extremely WWAM domestic transition." },
      { at: 1564, end: 1584, category: "WWAM UP IN YA", label: "DICK WANTS SOME DICK", excerpt: "Derry lore is interrupted by a name joke so obvious the room cannot resist saying it out loud." },
      { at: 1644, end: 1664, category: "STRAIGHT TO STEVE'S ASSHOLE", label: "HAND-UP-THE-ASS GUN", excerpt: "The missing monster is imagined as a puppet with a hand up its ass and a gun, turning the airbase mystery into a filthy prop gag." },
      { at: 1786, end: 1806, category: "BEST MOMENT", label: "THE STORE PICKLES", excerpt: "The pickle-store beat is singled out as one of the small human scenes that gives this episode more life than its exposition." },
      { at: 1938, end: 1958, category: "FAN SIGNAL", label: "MAYBE IT WAS THE SHOULDERS", excerpt: "A visual disagreement about a gun or a shoulder gets corrected in real time by the chat, exactly the kind of receipt this archive should preserve." },
      { at: 2008, end: 2028, category: "WWAM UP IN YA", label: "THE DICK BUMPER STICKER", excerpt: "A possible bumper sticker turns a Derry character's name into the most immature merch idea in the episode." },
      { at: 2237, end: 2257, category: "STRAIGHT TO STEVE'S ASSHOLE", label: "GOD'S GIFT OR SHITCAST", excerpt: "The hosts reject the internet's two-setting review machine: worship a show or dedicate an entire podcast to shitting on it." },
      { at: 2470, end: 2490, category: "FAN SIGNAL", label: "PAGAN HALLOWEEN EXCUSE", excerpt: "An apartment defense turns into a debate over people who call Halloween pagan while their porch lights stay dark." },
      { at: 2583, end: 2603, category: "WWAM UP IN YA", label: "COME UP FOR AIR", excerpt: "A chat member tells Jay to come up for air, and the room turns the warning into one more dirty sign-off gag." },
      { at: 2911, end: 2931, category: "THE ROOM BREAKS", label: "WHAT ARE THE HIGH SEAS?", excerpt: "A piracy reference completely fails to land until the hosts explain what the high seas are, producing the final confused laugh." },
    ]),
