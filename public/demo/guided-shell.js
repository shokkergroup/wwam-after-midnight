(function () {
  ...
  function recentCard(id, date, title, summary, topics, state) {
    return '<article class="guided-show-card">' +
      ...
      '<a href="?source=' + id + '&section=wiki#archive">OPEN SHOW WIKI <b>â†’</b></a></div>' +
    '</article>';
  }
  ...
  function buildGuidedHome() {
    ...
    host.innerHTML =
      ...
      '<div class="guided-latest-grid">' +
        ...
        recentCard("x6tvsGRHgU0", "JUN 30, 2026", "HORROR BOX OFFICE TIER LIST", "The recovered source map now opens Horror, Box Office, Superman and The Conjuring at exact times, with a full recap and best-moment jumps inside.", "HORROR &bull; BOX OFFICE &bull; SUPERMAN &bull; THE CONJURING", "RECOVERED WIKI") +
