(function (root) {
  ...
  sources["u9aRsfemqxg"] = Object.freeze({
    ...
    editorialPass: "2026-08-10 third fine-toothed full-audio read of the December 16, 2025 Welcome to Derry finale room; complete caption ledger, local audio windows, and aligned Whisper candidates rechecked across the Halloran/Shining handoff, Beverly bridge, studio-news detours, FAM questions, Loomis/Challis, Pennywise matchup math, and the filthy close; 24 additional source-bound jump points added",
    ...
    highlights: Object.freeze([
      ...
      { at: 586, end: 630, category: "WWAM UP IN YA", label: "DICK NEEDS A SHINING NAME TAG", excerpt: "The finale practically announces Dick Halloran's destination, so the room writes the hotel title on his forehead and lets the double meaning do the work." },
      { at: 922, end: 966, category: "DEEP DIVE", label: "THE SCARSGARD CRAFT-TABLE BILL", excerpt: "A joke about having twenty effects left turns into a question about how much Bill Skarsgård's craft table cost, then back into praise for the performance." },
      { at: 1028, end: 1072, category: "DEEP DIVE", label: "BEVERLY'S NETFLIX AMBUSH", excerpt: "The platform rolls straight from the finale into IT Chapter One, a shameless handoff that makes the room feel both manipulated and perfectly prepared." },
      { at: 2129, end: 2173, category: "STRAIGHT TO STEVE'S ASSHOLE", label: "NO FATE COSTS THIRTY BUCKS", excerpt: "A $30 game price and a title nobody can remember become a tiny consumer-rights case file in the middle of the movie-news detour." },
      { at: 2333, end: 2377, category: "TAKE GETS NUCLEAR", label: "FIRE AND ASH MUST BE VISIBLE", excerpt: "The room agrees that a studio cannot demand excitement for a hidden movie, then admits even Grace Randolph gets a point when she asks how anybody is supposed to react." },
      { at: 2387, end: 2431, category: "WWAM UP IN YA", label: "THE PIRATE IS THE AMERICAN PATRIOT", excerpt: "A possible phone-recorded leak gets defended as a patriotic public service, because the room would rather see the movie than keep squinting at a locked vault." },
      { at: 2456, end: 2500, category: "TAKE GETS NUCLEAR", label: "DOOMSDAY RELEASE-DATE COLLISION", excerpt: "Doomsday arriving with Supergirl is treated like a studio throwing two superheroes into the same bar fight and hoping one franchise survives." },
      { at: 2730, end: 2774, category: "WWAM UP IN YA", label: "THE MICROSCOPE TEASER", excerpt: "A teaser is so tiny that the room recommends microscopes and lenticulars before giving up and blaming the internet for making the clip impossible to judge." },
      { at: 2904, end: 2948, category: "FAN SIGNAL", label: "SANJAY WAYNE AFTER-DARK RECOMMENDATION", excerpt: "A tiny international clip becomes a drunk-watch recommendation, with Sanjay Wayne's secret-identity joke getting the loudest endorsement." },
      { at: 2956, end: 3000, category: "DEEP DIVE", label: "JAPANESE SPIDER-MAN IS THE BEST", excerpt: "The room pitches an international superhero stream and immediately brings up the Japanese Spider-Man who shoots people, because of course it does." },
      { at: 3066, end: 3110, category: "STRAIGHT TO STEVE'S ASSHOLE", label: "THE AI CUTSCENE GETS THE BOOT", excerpt: "One superhero shot is declared AI-looking, ugly, and more like a game cutscene than a finished film; the room refuses to pretend otherwise." },
      { at: 3316, end: 3360, category: "STRAIGHT TO STEVE'S ASSHOLE", label: "SILENT NIGHT TAKES THE SWING", excerpt: "The room hates part of the cast on paper, then tells the FAM to see Silent Night, Deadly Night anyway because the movie actually takes big swings." },
      { at: 3514, end: 3558, category: "WWAM UP IN YA", label: "HORSEY SAUCE RINGSIDE", excerpt: "A food-order detour tries to answer the tragic-story question with roast beef and horsey sauce before the room remembers it is supposed to be reviewing movies." },
      { at: 3777, end: 3821, category: "DEEP DIVE", label: "DENZEL'S FAVORITE SCENE IS THE ONE HE MISSED", excerpt: "Denzel Washington's favorite scene is praised even though he was not in it, a perfect little lesson in how a great actor can still know where the movie works." },
      { at: 3825, end: 3869, category: "WWAM UP IN YA", label: "RYAN REYNOLDS'S DENTAL PANIC", excerpt: "Ryan Reynolds admits he pretended to be angry because he was terrified of Denzel, which is the most believable Hollywood survival tactic in the episode." },
      { at: 3917, end: 3961, category: "DEEP DIVE", label: "PENNYWISE'S FEAR-ERA RULE", excerpt: "The shape-shifting theory gets a clean rule: Pennywise uses whatever the current era is afraid of, while Tim Curry and Bill Skarsgård can still look different and both work." },
      { at: 4052, end: 4096, category: "FAN SIGNAL", label: "DIANA STILL WINS THE CHAT", excerpt: "A fan asks who cares about Supergirl when Wonder Woman is missing, and the room answers with a simple truth: Diana is still cooler." },
      { at: 4286, end: 4330, category: "FAN SIGNAL", label: "LEON IS THE RE9 RECEIPT", excerpt: "Resident Evil 9 gets a playable-Leon confirmation, instantly turning a loose rumor into the most concrete piece of game news in the room." },
      { at: 4590, end: 4634, category: "FAN SIGNAL", label: "MICHAEL PARTON REOPENS THE IT REMAKE QUESTION", excerpt: "Michael Parton's question about whether the remake improves the original accidentally sends the room back into miniseries-versus-movie comparison." },
      { at: 4924, end: 4968, category: "STRAIGHT TO STEVE'S ASSHOLE", label: "FRODO AND SEAN BEAN GET PROTECTED", excerpt: "The Lord of the Rings argument stops being a debate when Frodo and Sean Bean are insulted; the room declares the Fellowship off-limits." },
      { at: 5063, end: 5107, category: "TAKE GETS NUCLEAR", label: "TIM CURRY'S PENNYWISE CROWN", excerpt: "The fan vote lands on Tim Curry, not because Bill Skarsgård is weak, but because Curry's original menace still owns the room." },
      { at: 5131, end: 5175, category: "CHARACTER PERFORMANCE", label: "JASON IS TOO DUMB FOR FEAR", excerpt: "Jason's advantage against Pennywise is brutally simple: if the monster needs fear, the hockey mask may have found the one opponent who cannot provide it.", characters: ["Jason Voorhees", "Pennywise"] },
      { at: 5207, end: 5251, category: "DEEP DIVE", label: "PENNYWISE DOESN'T EXPERIENCE TIME NORMALLY", excerpt: "The room likes the god-level time-lore breadcrumb and dislikes the explanation arriving as a shrug; the disagreement becomes the finale's last real canon fight." },
      { at: 5336, end: 5345, category: "SOUNDBYTE / REPLAY", label: "THE GOODBYE CURSE", excerpt: "The finale thanks the FAM, promises the next show, and then sends everybody away with a curse disguised as affection." },
    ]),
